...
PENDENCIAS_CONHECIDAS = [
    {"id": "C-NEW-01", "titulo": "ICMS da prestação de frete",
     "situacao": "Três evidências não reconciliadas. Bloqueia frete CIF."},
    {"id": "C-NEW-02", "titulo": "GRIS", "situacao": "Aplicabilidade não confirmada."},
    {"id": "C-NEW-06", "titulo": "Fiel depositário",
     "situacao": "0,5% da NF existe na tabela; quando incide, não."},
    {"id": "C-NEW-08", "titulo": "Base do pedágio",
     "situacao": "Peso real ou taxado — não declarado."},
    {"id": "C-NEW-04", "titulo": "Volume por SKU", "situacao": "Cadastro ausente."},
    {"id": "Q-L", "titulo": "Origem logística de Daune e Decor",
     "situacao": "Desconhecida. Frete CIF desses fornecedores fica A_COTAR."},
    {"id": "C-NEW-03", "titulo": "Passo Fundo-RS",
     "situacao": "Região sem tarifa — FRETE_A_COTAR."},
    {"id": "B-18", "titulo": "Poda de backup",
     "situacao": "Pode apagar o backup recém-criado. Preexistente."},
    {"id": "B-19", "titulo": "Scripts em massa",
     "situacao": "Dois quebram com cenário fiscal bloqueado. Preexistente."},
    {"id": "B-20", "titulo": "GET /logout",
     "situacao": "Muda estado via GET. Baixo risco."},
]
